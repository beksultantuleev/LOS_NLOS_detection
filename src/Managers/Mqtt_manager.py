    ...
    try:
        while True:
            while count != 200:
                ...
                test.publish('topic/1', f'1"[4, {count}, {65549343+np.random.randint(-100,200)}, {-78 - np.random.randint(1,3)}, {num}]')
                test.publish('topic/2', f'2"[4, {count}, {65549343+np.random.randint(-100,100)}, {-78 - np.random.randint(1,3)}, {num}]')
